...
import 'package:google_api_availability_android/google_api_availability_android.dart' as google_api_availability_android;
...
class _PluginRegistrant {
  ...
  static void register() {
    if (Platform.isAndroid) {
      try {
        google_api_availability_android.GoogleApiAvailabilityAndroid.registerWith();
      } catch (err) {
        print(
